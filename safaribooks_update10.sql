...
CREATE TABLE `procure` (
  `prcID` int(5) NOT NULL AUTO_INCREMENT,
  `bkID` int(5) NOT NULL,
...
INSERT INTO `user` VALUES ('cenealfr','cenera.a@safaribooks.com','4fe9e2decddc80d465af3f532262b731d9e378f5',NULL,'Alfrenido','Cenera','M.L. Quezon National Highway','Pajo','Lapu-Lapu City','Cebu',6015,2302800,1234567890,3,0);
...
-- Dump completed on 2014-01-18 10:13:44
