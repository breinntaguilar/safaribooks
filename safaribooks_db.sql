...
CREATE TABLE `credit` (
  ...
  `ccBank` varchar(45) NOT NULL,
  `ccNum` bigint(20) NOT NULL,
  `usrID` char(8) NOT NULL,
  `ccType` char(20) NOT NULL,
  PRIMARY KEY (`ccID`),
...
CREATE TABLE `user` (
  ...
  `usrPassConfirm` char(40) NOT NULL,
  `usrPassCurrent` char(40) NOT NULL,
  `usrPassUpdate` char(40) NOT NULL,
  ...
  `usrPhone` bigint(20) NOT NULL,
  `usrSSN` bigint(20) DEFAULT NULL,
...
INSERT INTO `user` VALUES ('custsamp','customer@safaribooks.com','1fae942f9fb3eba290e70b2031277ae850e5e49e','0','0','0','Sample','Customer','Barangay','Municipality','City','Cebu',6000,2537900,0,1,0),('emplsamp','employee@safaribooks.com','1fae942f9fb3eba290e70b2031277ae850e5e49e','0','0','0','Sample','Employee','Barangay','','City','Cebu',6000,2537900,0,1,0),('manasamp','manager@safaribooks.com','1fae942f9fb3eba290e70b2031277ae850e5e49e','0','0','0','Sample','Manager','Barangay','Municipality','City','Cebu',6000,2537900,0,1,0);
...
-- Dump completed on 2014-02-01  1:39:19
