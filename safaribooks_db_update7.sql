...
CREATE TABLE `cart` (
  ...
  PRIMARY KEY (`crtID`),
  KEY `fk_cart_customer_idx` (`cusID`),
  ...
  CONSTRAINT `fk_cart_customer` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `checkout` (
  ...
  PRIMARY KEY (`chkID`),
  KEY `fk_checkout_customer1_idx` (`cusID`),
  ...
  CONSTRAINT `fk_checkout_customer1` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `credit` (
  ...
  PRIMARY KEY (`ccNum`),
  KEY `fk_credit_customer1_idx` (`cusID`),
  CONSTRAINT `fk_credit_customer1` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customer` (
  ...
  `cusPass` char(40) NOT NULL,
  PRIMARY KEY (`cusID`),
  KEY `fk_customer_detail1_idx` (`cmnID`),
  CONSTRAINT `fk_customer_detail1` FOREIGN KEY (`cmnID`) REFERENCES `detail` (`cmnID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `customer` VALUES (1,1,'alfrenido@cenera.com','qwerty'),(2,2,'marlven@buhia.com','qazwsx');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `detail` (
  `cmnID` int(11) NOT NULL AUTO_INCREMENT,
  `cmnFname` varchar(45) NOT NULL,
  `cmnLname` varchar(45) NOT NULL,
  `cmnAddress1` varchar(45) NOT NULL,
  `cmnAddress2` varchar(45) DEFAULT NULL,
  `cmnCity` varchar(45) NOT NULL,
  `cmnProvince` varchar(45) NOT NULL,
  `cmnZIP` int(4) NOT NULL,
  `cmnPhone` int(11) NOT NULL,
  `cmnRole` int(1) NOT NULL,
  `cmnStat` tinyint(1) NOT NULL,
  PRIMARY KEY (`cmnID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detail` VALUES (1,'Alfrenido','Cenera','LLC',NULL,'','',0,3400094,1,1),(2,'Marlven','Buhia','CC',NULL,'','',0,2147483647,1,1);
...
CREATE TABLE `employee` (
  ...
  `cmnID` int(11) NOT NULL,
  `empPass` char(40) NOT NULL,
  `empSSN` int(10) NOT NULL,
  PRIMARY KEY (`empID`),
  KEY `fk_employee_detail1_idx` (`cmnID`),
  CONSTRAINT `fk_employee_detail1` FOREIGN KEY (`cmnID`) REFERENCES `detail` (`cmnID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `procure` (
  ...
  KEY `fk_procure_employee1_idx` (`empID`),
  CONSTRAINT `fk_procure_book1` FOREIGN KEY (`bkID`) REFERENCES `book` (`bkID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_procure_employee1` FOREIGN KEY (`empID`) REFERENCES `employee` (`empID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `review` (
  ...
  PRIMARY KEY (`revID`),
  KEY `fk_review_customer1_idx` (`cusID`),
  KEY `fk_review_employee1_idx` (`empID`),
  ...
  CONSTRAINT `fk_review_customer1` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_review_employee1` FOREIGN KEY (`empID`) REFERENCES `employee` (`empID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `review` VALUES (1,1,NULL,1310001,'Good!',4,1),(2,2,NULL,1310001,'Bad!',1,1);
...
CREATE TABLE `wishlist` (
  ...
  `bkID` int(5) NOT NULL,
  PRIMARY KEY (`wshID`),
  KEY `fk_wishlist_customer1_idx` (`cusID`),
  ...
  CONSTRAINT `fk_wishlist_customer1` FOREIGN KEY (`cusID`) REFERENCES `customer` (`cusID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-11-20 12:17:11
